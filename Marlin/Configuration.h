...
#define STRING_CONFIG_H_AUTHOR "(steven mccaw, mpmsv2 11/27/23)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Pennyb0ne"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 359.86
  #define DEFAULT_bedKi 70.91
  #define DEFAULT_bedKd 1217.53
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 7, 50, -1.85 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_HOTEND_TEMP  260    // (°C) Default nozzle temperature for G26.
